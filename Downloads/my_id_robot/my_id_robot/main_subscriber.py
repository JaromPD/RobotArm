...
start_commands = ["hey are too", "hey are to", "hey are two", "hey or too", "hey or to", "hey or two", "he are to", "here to", "he or to", "here are two", "care or to"]
arduino_commands = ["forward", "left", "right", "back", "stop", "projector", "turn head", "spin", "roam", "explore", "wander", "display"]
...
#        call(["espeak", "-ven-us+f3", msg.data])
        ...
        if (msg.data.find("color") != -1):
            call(["aplay", "/home/redleader/ros2_ws/src/my_id_robot/my_id_robot/sounds/Victory.wav"])
